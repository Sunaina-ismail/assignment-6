      ...
      <div className="bg-purple-800 rounded-lg p-6 sm:p-8 lg:p-10">
        <form className="space-y-6">
          ...
          <div className="text-center">
            <button
              type="submit"
              className="px-6 py-3 bg-white  text-purple-900 font-semibold rounded-lg shadow-md  hover:bg-purple-600 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primaryColor transition ease-in-out duration-300"
            >
              Send Message
            </button>
          </div>
